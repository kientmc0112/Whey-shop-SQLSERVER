<?php 
    ...
    $sql="SELECT * FROM tbl_order where IdOrder = '$id'";
    ...
    <div class="row">
        <div class="col-xs-12 col-sm-12 col-md-12 col-lg-12">
            <table class="table table-striped">
                ...
                <?php
                    $idorder = $row["IdOrder"];
                    $sql1="SELECT * FROM tbl_order_detail where IdOrder = '$idorder'";
                    $query1= sqlsrv_query($conn_sqlsrv, $sql1);
                    while ($row1 = sqlsrv_fetch_array($query1)) {
                        $idproduct = $row1["IdProduct"];
                        $sql2="SELECT * FROM tbl_product where IdProduct = '$idproduct'";
