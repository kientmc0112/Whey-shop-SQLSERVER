...
<?php 
	if (isset($_GET["id"])) {
		...
		if (isset($_POST["btn_update"])) {
			...
			$sql="UPDATE tbl_product SET NameProduct=N'$nameproduct',OriginalPrice='$originalprice',OldPrice='$oldprice',NewPrice='$newprice',UrlImage='$urlimage',Note=N'$note',Description=N'$description',ProductContent=N'$content',AmountOriginal='$amount_original',Amount='$amount',IdGroupDetail='$idgroupdetail',IdProvider='$idprovider' WHERE IdProduct='$id'";
		...
		<div class="col-xs-6 col-sm-6 col-md-6 col-lg-6">
			...
			<div class="col-xs-6 col-sm-6 col-md-6 col-lg-6">
				...
				<div class="form-group">
					...
					?>
					<option value="<?php echo($row1["IdGroupDetail"])?>" selected><?php echo $row1["NameGroupDetail"] ?></option>
					<?php 
							} else { 
					?>
				...
				<div class="form-group">
					...
					<?php 
						...
						while ($row1 = sqlsrv_fetch_array($query1)) {
							// if ($row["IdProvider"] != "") {
							if ($row1["IdProvider"] == $row["IdProvider"]) {
					?>
					<option value="<?php echo($row1["IdProvider"])?>" selected><?php echo $row1["NameProvider"] ?></option>
					<?php 
							} else { 
					?>
