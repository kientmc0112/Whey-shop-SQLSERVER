            ...
            <table class="table table-bordered "  >
                ...
                <tbody id="myTable">
                    ...
                    <tr>
                        ...
                        <td class="td_bill">
                            <a href="index.php?page=update_news_group&&id=<?php echo($row["IdNewsGroup"]) ?>" class="btn btn-success btn-xs " ><span class="fa fa-wrench" style=" margin-right: 5px"></span>Sửa</a>
                            <a href="View/delete.php?idnewsgroup=<?php echo($row["IdNewsGroup"]) ?>" class="btn btn-danger btn-xs" onclick="return confirm('Bạn có chắc chắn muốn xóa')"><span class="fa fa-trash-alt" style=" margin-right: 5px"></span>Xóa</a>
                        </td>
                    </tr>
                    <?php 
                        } 
