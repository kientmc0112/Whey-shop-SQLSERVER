        ...
        <div class="col-xs-12 col-sm-12 col-md-12 col-lg-12 quanlysanpham animated zoomIn" >
            ...
            <table class="table table-bordered " >
                ...
                <tr>
                    ...
                    <!-- <td class="td_bill">
                        <a href="View/delete.php?idcustomer=<?php echo $row["IdCustomer"] ?>" class="btn btn-danger btn-xs" onclick="return confirm('Bạn có chắc chắn muốn xóa')"><span class="fa fa-trash-alt" style=" margin-right: 5px"></span>Xóa</a>
                    </td> -->
                </tr>
                <?php 
                    } 
