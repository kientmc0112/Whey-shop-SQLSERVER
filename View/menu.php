    <div class="menu">
        <a href="index.php"><img src="upload/san-deal.jpg" style="width: 1347px; height: 37px;" class="animated flash"></a>
                    ...
                    <div id="navbar-right">
                        <ul class="nav navbar-nav navbar-right">
                            ...
                            <li class="dropdown">
                                ...
                                <?php 
                                    $sql2="SELECT * FROM tbl_group_detail WHERE IdGroupProduct = ' $IdGroupProduct'";
                                    $query2= sqlsrv_query($conn_sqlsrv, $sql2);
                                    while($row2 = sqlsrv_fetch_array($query2)) {
                                ?>
                                    <li>
                                        <a href="index.php?page=group&&idgroupproduct=<?php echo($row['IdGroupProduct']) ?>&&idgroupdetail=<?php echo($row2['IdGroupDetail']) ?>"><?php echo($row2["NameGroupDetail"]) ?>
                                        </a>
                                    </li>
                                <?php 
                                    } 
                            ...
                            <li class="dropdown">
                                ...
                                <?php 
                                    ...
                                    while ($row = sqlsrv_fetch_array($query)) {
                                ?>
                                    <li><a href="index.php?page=group&&idprovider=<?php echo($row["IdProvider"]) ?>"><?php echo($row["NameProvider"]) ?></a></li>
                                <?php
                                    }
                                ?>
                                </ul>
        ...
        <nav class="navbar navbar-default desktop" role="navigation" >
            <div class="container">
                ...
                <div class="navbar-header">
                    ...
                    <div class="logo">
                        <a class="navbar-brand" data-toggle="modal" href='#modal-id1'><span class="fa fa-heartbeat" style="margin-right: 5px"></span>Hệ thống cửa hàng</a>
                    </div>
                </div>
                ...
                <div class="collapse navbar-collapse navbar-ex1-collapse">
                    <div id="navbar-right">
                        <ul class="nav navbar-nav navbar-right">
                            <li><a href="#" id="whey_menutop">Smartphone</a></li>
                            <li><a href="#" id="sua_menutop">Tablet</a></li>
                            <li><a href="#" id="tin_menutop">Mobile phone</a></li>
                            <li class="dropdown">
                                <a href="#" class="dropdown-toggle" data-toggle="dropdown">Nhà sản xuất<b class="caret"></b></a>
                                <ul class="dropdown-menu">
                                <?php 
        ...
        <div class="container" style="padding: 5px 0px">
            <div class="row">
                <div class="col-xs-12 col-sm-12 col-md-3 col-lg-3 logo">
                    <a href="index.php?page=home"><img src="upload/logo.png" alt="" style="" class="animated zoomIn"></a>
                </div>
                ...
                <div class="col-xs-4 col-sm-4 col-md-2 col-lg-2">
                    ...
                    ?>
                    <div id="dangxuat">
                        <a style="color: #409217;font-weight: bold;" class="xinchao" class="dropdown-toggle" data-toggle="dropdown" href="#">
                            <?php echo($_SESSION["user"]) ?>
                            <span class="caret"></span>
                        </a>
                        <ul class="dropdown-menu">
                            <li>
                                <a class="btn" id="update" style="color: #409217;"><span class="glyphicon glyphicon-wrench" style="margin-right: 5px"></span>Thay đổi thông tin</a>
                            </li>
                            <li>
                                <a href="View/logout.php" style="color: #409217;"><span class="glyphicon glyphicon-log-out" style="margin-right: 5px"></span>Đăng xuất</a>
                            </li>
                        </ul>
                ...
                <div class="col-xs-4 col-sm-4 col-md-2 col-lg-2 ">
                    <div id="menu-right">
                        <img src="upload/icon_cart.png" alt="" style="width: 25%" class="animated zoomIn">
        ...
        <div class="modal-dialog">
            <div class="modal-content">
                <div class="modal-header">
                    ...
                    <h4 class="modal-title">Hệ thống cửa hàng của mello</h4>
                </div>
