<div id="main">
    <div class="container cn">
        <div class="row" class="san_pham_noi_bat">
            ...
            <hr>
            <?php 
                $sql= "select TOP 6* from tbl_product ORDER BY IdProduct DESC";
            ...
            <div class="col-xs-6 col-sm-6 col-md-2 col-lg-2 kc">
                <a href="index.php?page=detail&&idproduct=<?php echo($row['IdProduct']) ?>">
                    <div class="thumbnail text-center">
                        ...
                        <div class="caption">
                            <p class="p_1" style="height: 36px"><?php echo($row["Note"]) ?></p>
    ...
    <div class="container-fluid cf" style="background: #EC5C61">
        <div class="container" style="padding-bottom: 60px;">
            <div class="row">
                ...
                <?php 
                    $rand = rand(1,6);
                    $sql= "select TOP 6* from tbl_product where OldPrice != '' order by IdProduct DESC  ";
                    $result = sqlsrv_query($conn_sqlsrv, $sql);
                    while ($row = sqlsrv_fetch_array($result)) {
                ?>
                <div class="col-xs-6 col-sm-6 col-md-2 col-lg-2 kc">
                    <a href="index.php?page=detail&&idproduct=<?php echo($row['IdProduct']) ?>">
                        <div class="thumbnail text-center">
                            ...
                            <div class="caption">
                                ...
                                <p><a href="index.php?page=detail&&idproduct=<?php echo($row['IdProduct']) ?>" class="btn btn-default"><b><span class="fa fa-eye" style="margin-right: 5px"></span>Chi tiết</b></a></p>
                            </div>
                            <?php  
                                if ($row["OldPrice"] != 0) {
                                    $oldprice =  $row["OldPrice"];
    ...
    <div class="container cn"> 
        <div class="row">
            ...
            <hr>
            <?php 
                $sql= "select TOP 6* from tbl_product ORDER BY Amount DESC ";
                $result = sqlsrv_query($conn_sqlsrv, $sql);
                while ($row = sqlsrv_fetch_array($result)) {
            ?>
            <div class="col-xs-6 col-sm-6 col-md-2 col-lg-2 kc">
    ...
    <div class="container cn">
        <div class="row h3_whey">
            ...
            <hr>
            <?php 
                $sql= "select TOP 6* from tbl_product where IdGroupDetail in (select IdGroupDetail from tbl_group_detail where IdGroupProduct = '1') order by IdProduct DESC";
                $result = sqlsrv_query($conn_sqlsrv, $sql);
                while ($row = sqlsrv_fetch_array($result)) {
            ?>
            <div class="col-xs-6 col-sm-6 col-md-2 col-lg-2 kc">
