        ...
        <form action="View/process_pay.php" method="post">
            ...
            <div class="col-xs-6 col-sm-6 col-md-6 col-lg-6 right">
                ...
                <select class="form-control quanhuyen" name="sl_quanhuyen" >
                    ...
                    <?php 
                        $sql1="SELECT * FROM devvn_quanhuyen ORDER BY name ASC";
                        $query1= sqlsrv_query($conn_sqlsrv1, $sql1);
                        while ($row1 = sqlsrv_fetch_array($query1)) {
                    ?>
                    <option value="<?php echo $row1["maqh"] ?>"><?php echo $row["name"] ?></option>
                    <?php 
                        }
                    ?>
                </select> -->
    ...
    <div class="container-fluid" >
        <?php 
            if (isset($_SESSION["user"])) {
                ...
                $sql="SELECT * FROM tbl_order where IdCustomer = '$idcustomer' order by IdOrder DESC";
                $params = array();
